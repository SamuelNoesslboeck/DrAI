...
rand = RandomLineDrawer( "rand0", inp, input_image, settings[ "random-line-cache" ], pen_size = 4, num_random_lines = 20 )
...
llm = LLM( "llm1", prompt = merg, prevElement = rand, prevElementKey = "<INPUT>" )
