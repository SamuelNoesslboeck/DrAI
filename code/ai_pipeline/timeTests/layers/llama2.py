...
def timeLLama2( weightsPath : str = "./weights/llm/llama-2-7b-chat.ggmlv3.q8_0.bin" ):
    print( "|---------------------------------|" )
    print( "|  Testing Time for LLama2 Model  |" )
    print( "|---------------------------------|" )
    print( " " )

    print( ">>> Loading Model..." )
    LLM_MODEL = LlamaCpp( model_path = weightsPath )
    print( ">>> Model loaded" )
    ...
    print( ">>> Time per Token:" )
    print( ( end - start ) / numTokens )
    print( ">>> Time for 70 Tokens (Maximum Stable Diffusion can handle)")
    print( ( end - start ) / numTokens * 70 )