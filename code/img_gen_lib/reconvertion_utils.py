...
def transformImg( img ):
    ...
    cornerPositions, ( topLeftCorner, topRightCorner, bottomLeftCorner, bottomRightCorner ) = cornerDistances( indexes, img.shape[ 1 ], img.shape[ 0 ] )
    ...
    #Return the final image and the top left corner and the angle of the paper
    return final, ( corners[ 0 ], np.arctan2( topRightCorner[ 0 ] - topLeftCorner[ 0 ], topRightCorner[ 1 ] - topLeftCorner[ 1 ] ) )
